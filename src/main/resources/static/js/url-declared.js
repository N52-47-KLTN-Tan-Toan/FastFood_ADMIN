...
const url_api_product = 'http://ffapi.azurewebsites.net/api/v1/mat-hang'
const url_api_categories = 'http://ffapi.azurewebsites.net/api/v1/loai-mat-hang'
const url_api_client = 'http://ffapi.azurewebsites.net/api/v1/khach-hang'
const url_api_order = 'http://ffapi.azurewebsites.net/api/v1/don-dat-hang'
const url_api_introduce = 'http://ffapi.azurewebsites.net/api/v1/gioi-thieu'
const url_api_orderdetail = 'http://ffapi.azurewebsites.net/api/v1/chi-tiet-don-dat-hang'
const url_api_staff = 'http://ffapi.azurewebsites.net/api/v1/nhan-vien'
